...
export function Contact() {
	...
	return (
		<SectionWrapper className="my-16" id="contact">
				...
				<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
					<div className="space-y-6">
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel htmlFor="email" className="tracking-wider">
										Email
									</FormLabel>
									<FormControl>
										<Input
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel htmlFor="message" className="tracking-wider">
										Message
									</FormLabel>
									<FormControl>
										<Textarea
